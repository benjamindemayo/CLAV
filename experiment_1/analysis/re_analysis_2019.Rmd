...
The model fails to converge with age as a categorical variable. As a continuous variable, the model shows a significant main effect of age on accuracy, but shows no effect of trial type or age-trial type interaction on accuracy, which is puzzling given visualizations of the data.
